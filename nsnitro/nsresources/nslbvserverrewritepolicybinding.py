...
class NSLBVServerRewritePolicyBinding(NSBaseResource):
    ...
    def get(nitro, csvserver_rewritepolicy_binding):
        ...
        """
        __url = nitro.get_url() + NSLBVServerRewritePolicyBinding.get_resourcetype() + \
            "/" + csvserver_rewritepolicy_binding.get_name()
        __json_resources = nitro.get(__url).get_response_field(
            NSLBVServerRewritePolicyBinding.get_resourcetype())
        __resources = []
    ...
    def add(nitro, csvserver_rewritepolicy_binding):
        ...
        __csvserver_rewritepolicy_binding.set_name(
            csvserver_rewritepolicy_binding.get_name())
        __csvserver_rewritepolicy_binding.set_policyname(
            csvserver_rewritepolicy_binding.get_policyname())
        __csvserver_rewritepolicy_binding.set_priority(
            csvserver_rewritepolicy_binding.get_priority())
        __csvserver_rewritepolicy_binding.set_gotopriorityexpression(
            csvserver_rewritepolicy_binding.get_gotopriorityexpression())
        __csvserver_rewritepolicy_binding.set_bindpoint(
            csvserver_rewritepolicy_binding.get_bindpoint())
        __csvserver_rewritepolicy_binding.set_invoke(
            csvserver_rewritepolicy_binding.get_invoke())
        __csvserver_rewritepolicy_binding.set_labeltype(
            csvserver_rewritepolicy_binding.get_labeltype())
        __csvserver_rewritepolicy_binding.set_labelname(
            csvserver_rewritepolicy_binding.get_labelname())
